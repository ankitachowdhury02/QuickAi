  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center
     ...
     <div className='text-center mb-6'>
        ...
        font-semibold mx-auto leading-[1.2]'>Use AI Tools to <br/> craft <span className='text-primary'> stunning content</span></h1>
        <p className='mt-4 max-w-x5 sm:max-w-lg 2xl:max-w-xl m-auto
        max-sm:text-xs text-gray-600'>Create smarter, faster, and better with our premium AI tools—write content, generate visuals, and boost your productivity.</p>
     </div>
